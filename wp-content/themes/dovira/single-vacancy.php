					...
					<div class="vacancy__layer vacancy__description">
						...
						<div class="vacancy__form-holder contacts-form7">
							...
							<?php else :
								...
								if ( $current_language_slug === 'uk' ) :?>
									<?= do_shortcode( '[contact-form-7 id="f8f78c9" title="Форма заявки на вакансію" vacancy="' . $post->ID . '"]' ); ?>
								<?php elseif ( $current_language_slug === 'ru' ) : ?>
									<?= do_shortcode( '[contact-form-7 id="48d74aa" title="Форма заявки на вакансію RU" vacancy="' . $post->ID . '"]' ); ?>
								<?php endif; ?>
							<?php endif; ?>
