...
$fields = new FieldsBuilder( 'services' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">SERVICES</span>', array(
...
$fields->addTab( 'services_tab', array(
	'label' => __( 'Services', 'dovira' ),
) );
...
$fields->addTrueFalse( 'is_show_all', array(
	'label'         => __( 'Show all services?', 'dovira' ),
	'ui'            => 1,
	'ui_on_text'    => __( 'Yes', 'dovira' ),
	'ui_off_text'   => __( 'No', 'dovira' ),
	'default_value' => 0
...
$fields->addTrueFalse( 'is_search_visible', array(
	'label'         => __( 'Show search?', 'dovira' ),
	'ui'            => 1,
	'ui_on_text'    => __( 'Yes', 'dovira' ),
	'ui_off_text'   => __( 'No', 'dovira' ),
	'default_value' => 0,
...
$fields->addRelationship( 'services', array(
	'label'             => __( 'Services', 'dovira' ),
	'post_type'         => 'service',
	'conditional_logic' => array(
		array(
...
$fields->setLocation( 'block', '==', 'acf/services' );
