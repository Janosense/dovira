...
$fields = new FieldsBuilder( 'news' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">NEWS</span>', array(
...
$fields->addTab( 'news_tab', array(
	'label' => __( 'News', 'dovira' ),
) );
...
$fields->addTrueFalse( 'is_latest_news', array(
	'label'         => __( 'Show latest news?', 'dovira' ),
	'ui'            => 1,
	'ui_on_text'    => __( 'Yes', 'dovira' ),
	'ui_off_text'   => __( 'Choose manually', 'dovira' ),
	'default_value' => 1
) );

$fields->addNumber( 'count_news', array(
	'label'             => __( 'Count news', 'dovira' ),
	'default_value'     => 3,
	'conditional_logic' => array(
		array(
			array(
				'field'    => 'is_latest_news',
				'operator' => '==',
				'value'    => 1
			),
		),
...
$fields->addRelationship( 'news', array(
	'label'             => __( 'News', 'dovira' ),
	'post_type'         => 'post',
	'conditional_logic' => array(
		array(
...
$fields->setLocation( 'block', '==', 'acf/news' );
