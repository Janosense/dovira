...
$fields = new FieldsBuilder( 'vacancies' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">VACANCIES</span>', array(
...
$fields->setLocation( 'block', '==', 'acf/vacancies' );
