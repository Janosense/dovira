...
$fields = new FieldsBuilder( 'seo-text' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">SEO TEXT</span>', array(
...
$fields->setLocation( 'block', '==', 'acf/seo-text' );
