...
$fields = new FieldsBuilder( 'entity-links' );
...
$fields->addTab( 'links_tab', array(
	'label' => __( 'Links', 'dovira' ),
) );

$fields->addSelect( 'entity', array(
	'label'   => __( 'Entity', 'dovira' ),
	'choices' => array(
		'custom' => __( 'Custom Links', 'dovira' ),
		'posts'  => __( 'Posts', 'dovira' ),
	)
) );

$fields->addRepeater( 'custom_links', array(
	'label'             => __( 'Custom Links', 'dovira' ),
	'layout'            => 'block',
...
$fields->addRelationship( 'posts', array(
	'label'             => __( 'Posts', 'dovira' ),
	'conditional_logic' => array(
		array(
			array(
				'field'    => 'entity',
...
$fields->setLocation( 'block', '==', 'acf/entity-links' );
