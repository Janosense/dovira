				...
				<div
					...
					<div class="contacts__text-holder contacts__text-holder--<?= $text_align; ?>"
						...
						<?php if ( ! empty( $contact['city'] ) ) :
							if ( empty( $contact['heading_level'] ) ) {
								$contact['heading_level'] = 'h2';
							}
							if ( empty( $contact['heading_style'] ) ) {
								$contact['heading_style'] = 'h2';
							}
							if ( empty( $contact['heading_color'] ) ) {
								$contact['heading_color'] = '#3c3c3c';
							}
							?>
