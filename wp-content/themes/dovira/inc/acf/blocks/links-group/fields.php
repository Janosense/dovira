...
$fields = new FieldsBuilder( 'links-group' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">LINKS GROUP</span>', array(
...
$fields->addRepeater( 'links', array(
	'label' => __( 'Links', 'dovira' ),
	'layout'       => 'block',
) )
       ->addLink( 'item', array(
	       'label' => __( 'Link', 'dovira' ),
       ) )
       ->addSelect( 'style', array(
	       'label'         => __( 'Text alignment', 'dovira' ),
	       'choices'       => array(
		       'white'   => __( 'White', 'dovira' ),
		       'violet-light' => __( 'Violet', 'dovira' ),
	       ),
	       'default_value' => 'white',
       ) );
...
$fields->setLocation( 'block', '==', 'acf/links-group' );
