...
$fields = new FieldsBuilder( 'employees' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">EMPLOYEES</span>', array(
...
$fields->addTab( 'employees_tab', array(
	'label' => __( 'Employees', 'dovira' ),
) );
...
$fields->addTrueFalse('show_all_employees', array(
	'label'         => __( 'Show All Employees?', 'dovira' ),
	'ui'            => 1,
	'ui_on_text'    => __( 'Yes', 'dovira' ),
	'ui_off_text'   => __( 'No', 'dovira' ),
	'default_value' => 1
...
$fields->addRelationship( 'employees', array(
	'label'     => __( 'Employees', 'dovira' ),
	'post_type' => 'employee',
	'filters'   => array(
		0 => 'search',
...
$fields->setLocation( 'block', '==', 'acf/employees' );
