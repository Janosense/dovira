...
$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">ABOUT</span>', array(
...
$fields->addTab( 'years_tab', array(
	'label' => __( 'Years', 'dovira' ),
) );

$fields->addRepeater( 'years', array(
	'label'  => __( 'Years', 'dovira' ),
	'layout' => 'block',
) )
       ->addText( 'year', array(
	       'label' => __( 'Year', 'dovira' ),
       ) )
       ->addText( 'period', array(
	       'label' => __( 'Period', 'dovira' ),
       ) )
       ->addText( 'title', array(
	       'label' => __( 'Title', 'dovira' ),
       ) )
       ->addWysiwyg( 'text', array(
...
$fields->setLocation( 'block', '==', 'acf/about' );
