...
$fields = new FieldsBuilder( 'questionary' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">QUESTIONARY</span>', array(
...
$fields->setLocation( 'block', '==', 'acf/questionary' );
