...
$fields = new FieldsBuilder( 'contacts-simple' );

$fields->addMessage( 'block-name', '<span style="font-weight: bold; font-size: 32px">CONTACTS SIMPLE</span>', array(
...
$fields->setLocation( 'block', '==', 'acf/contacts-simple' );
